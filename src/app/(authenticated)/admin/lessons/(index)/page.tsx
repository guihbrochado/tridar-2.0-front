...
export default async function LessonsPage() {
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Aulas" backPage="Aulas" backPageLink="/admin/lessons" />
            <div className="flex flex-row mb-5 justify-end">
                <Link className="bg-white text-black px-4 py-2 rounded-lg" href="/admin/lessons/add">Adicionar Aula</Link>
            </div>
