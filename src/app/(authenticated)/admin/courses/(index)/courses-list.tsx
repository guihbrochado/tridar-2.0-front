                                            ...
                                            <div className="bg-gray-900 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                                <div className="sm:flex sm:items-start">
                                                    ...
                                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                        <h3 className="text-base font-semibold leading-6 text-white" id="modal-title">Deletar Curso</h3>
                                                        <div className="mt-2">
                                                            <p className="text-sm text-gray-400">Tem certeza que deseja deletar este curso?</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="bg-gray-800 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                                <button onClick={deleteCourse} type="button" className="inline-flex w-full justify-center rounded-md bg-[#f87171] px-3 py-2 text-sm font-semibold text-white shadow-sm  hover:bg-red-600 sm:ml-3 sm:w-auto">Deletar</button>
