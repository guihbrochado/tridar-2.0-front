...
import OrderDetailsCourseCard from "../../../components/OrderDetailsCourseCard";
    ...
    return (
        <div className="max-w-1680 mx-10">
            ...
            <div className="flex flex-row w-full gap-4">
                {!wasPaid && <div className="flex flex-col w-2/3 items-center gap-3 border border-gray-dark p-4 rounded-lg">
